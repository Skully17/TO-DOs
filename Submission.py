#Program Created By David Ellis   ID: 3728275    Email: ellisd5@lsbu.ac.uk - Elliott Gipson ID: 3723604 Email: gipsone@lsbu.ac.uk
...
class __Database(list): #This works as a list, designed to print the contents in a one by one format
    def __str__(self):
        for item in self:
            print(item)


class ScreenBase(Frame): #This function works as a foundation for all screens
    def __init__(self, master):
        self.months = {name: num for num, name in enumerate(calendar.month_name) if num}
        super().__init__(master)  #This initiates a parent class
        self.grid()
        self.create_widgets()
...
class ToDo(object): #This designates a class function that sets out different segments of the system
    ...
    def __str__(self): #This function is called whenever something needs to be printed
        ...
        for item in self.attributes():
            return_value += '%s: %s  ' % (item, str(self.__getattribute__(item)))  #This is used to add the item and its value to a return string
        return return_value
    ...
    def attributes(self):
        #This is iterates over the first 6 items in the list on an objects attributes
...
class MenuScreen(ScreenBase): #This class if for the menu screen of the system
    ...
    def create_widgets(self): #This function is used to create widgets inside the application
        ...
        self.add_todo = Button(self, text='Add TO-DO', command=self.add_to_do) #These lines add buttons to the app
    ...
    def add_to_do(self): #This function is used to present the Add screen
...
class ModifyScreen(ScreenBase): #This class is for any work done to modify the screen
    ...
    def create_widgets(self): #This function is for creating widgets for this page
        ...
        start_date_label = Label(self.modify_window, text='Start Date: ') #This segment is for the start section
        ...
        due_date_label = Label(self.modify_window, text='Due Date: ') #This segment is for the due dates section
    ...
    def set_text(self, widget, text): #This is a function for setting text
        widget.delete(0, END)
...
def write_to_file():
    ...
    for todo in Database:
        ...
        to_write += "\n"  #This adds a new line at end of every todo
    # writes
...
def objectify_todo_dates(): #This is a function that looks for a to do in the database and splits through the string accordingly
    try:
        for todo in Database:
...
Database = __Database() #This is a list that holds all the to-dos which was made at the start
